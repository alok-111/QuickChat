...
const LoginPage = () => {
  ...
  const [isDataSumbitted , setIsDataSubmitted] = useState(false);
     ...
     {/* ---------leftSide Content ----------- */}
       ...
       <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
          <h2 className='font-medium text-2xl flex justify-between items-center'>
            ...
            {isDataSumbitted && <img onClick={() => setIsDataSubmitted(false)} src={assets.arrow_icon} alt="arrow" className='w-5 cursor-pointer'/>
            }            
            
            </h2>
             
              {currState=== "Sign up" && !isDataSumbitted && (
